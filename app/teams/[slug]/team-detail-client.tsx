...
function TeamPage({
  ...
  preloadedTeam: Preloaded<typeof api.teams.getTeamBySlug>;
  preloadedRoster: Preloaded<typeof api.players.getPlayersByTeam>;
  preloadedBoard: Preloaded<typeof api.teams.getBoard>;
}) {
